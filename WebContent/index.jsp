...
<body>
	...
	<div class="container">
		<table class="table" style="text-align: center; border: 1px solid #dddddd">
			...
			<tbody>
				<tr>
					<td style="background-color: #fafafafa; text-algin:center;"><h5>이름</h5></td>
					<td><input class="form-control" type="text" id="registerName" size="20"></td>			
				</tr>
				<tr>
					<td style="background-color: #fafafafa; text-algin:center;"><h5>나이</h5></td>
					<td><input class="form-control" type="text" id="registerAge" size="20"></td>
						
					
				</tr>
				<tr>
					<td style="background-color: #fafafafa; text-algin:center;"><h5>성별</h5></td>
					<td>
						<div class="form-gorup" style="text-align: center; margin: 0 auto;">
				...
				<tr>
					<td style="background-color: #fafafafa; text-algin:center;"><h5>이메일</h5></td>
